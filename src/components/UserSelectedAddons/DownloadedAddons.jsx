...
import { getUserDownloads } from "../../services/users.service";
...
export const DownloadedAddons = ({ username }) => {
  ...
  useEffect(() => {
    async function fetchAddons() {
      try {
        const userAddonsIds = await getUserDownloads(username);
  ...
  return (
    ...
    <div className="example overflow-x-auto">
      {addons.length === 0 && (
        <p>It looks like you haven&apos;t downloaded anything yet.</p>
      )}
